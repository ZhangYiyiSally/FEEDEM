...
class Loss:
    ...
    def loss_function(self, Tetra_coord: torch.Tensor, 
        ...
        loss = energy_loss + loss_weight*integral_boundaryloss + loss_weight*(Pre_load==cfg.Pre_value[1])*integral_drivenloss
        ...
        return loss, energy_loss, loss_weight*integral_boundaryloss, loss_weight*(Pre_load==cfg.Pre_value[1])*integral_drivenloss
